     ...
     <div className='w-full px-[2%]'>
              <div className='pb-[50px]'>
                <div className='flex justify-between place-items-center '>
                  ...
                  <button className='px-[20px] h-[30px] lg:h-[35px] xl:h-[40px] border-[1px] border-[#0F52BA]  hover:bg-[#F2F7FF] rounded-[6px] text-[14px] xl:text-[16px] font-normal cursor-pointer'>Print Invoice</button>
                     <div >
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    ...
                    width={0}
                    height={0}
                    className='w-[30px] lg:w-[35px] xl:w-[40px] h-[30px] lg:h-[35px] xl:h-[40px] cursor-pointer'
                      src="/assests/comman/3dots.svg"
                    />
                ...
                >
                  ...
                  <DropdownMenuGroup className=' '>
                    <DropdownMenuItem>
                     ...
                     <Image alt='back' onClick={() => router.back()} width={0} height={0} className='w-[30px] lg:w-[35px] xl:w-[40px] h-[30px] lg:h-[35px] xl:h-[40px] cursor-pointer ' src="/assests/comman/boxbackarray.svg"/>
                   </div>
                   </div>

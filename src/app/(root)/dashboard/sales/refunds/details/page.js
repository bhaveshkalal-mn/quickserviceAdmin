     ...
     <div className='w-full px-[2%]'>
              <div className='pb-[50px]'>
                <div className='flex justify-between place-items-center '>
                   <h1 className='text-[18px] lg:text-[20px] font-normal'>Refund Details (#001) </h1>
                     ...
                     <div className='border-[1px] border-[#EBEBEB] rounded-[6px] mt-[15px] lg:mt-[20px]'>
                       <div className='grid grid-cols-4'>
                        ...
                        <div className='flex justify-between'>
                          ...
                          <div className='px-[20px] xl:px-[25px] py-[15px] xl:py-[20px] mb-[20px]'>
                                <h1 className='text-[12px] xl:text-[14px] font-bold'> Refund Request Info</h1>
                               <div className='mt-[10px]'>
                                    <h1 className='text-[12px] xl:text-[14px] font-normal'>Date : 01-02-2025 10:02 <br></br> Reason : Defect in the product <br></br>Amount Requested : </h1>

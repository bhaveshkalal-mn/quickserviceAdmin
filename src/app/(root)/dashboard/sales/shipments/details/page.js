     ...
     <div className='w-full px-[2%]'>
              <div className='pb-[50px]'>
                <div className='flex justify-between place-items-center '>
                   <h1 className='text-[18px] lg:text-[20px] font-normal'>Shipment Details (#SHP12345)</h1>
                     ...
                     <div className='border-[1px] border-[#EBEBEB] rounded-[6px] mt-[15px] lg:mt-[20px]'>
                       <div className='grid grid-cols-4'>
                        ...
                        <div className='flex justify-between'>
                         ...
                         <div className='border-[1px] w-[75%] border-[#EBEBEB] rounded-[6px] mt-[15px] lg:mt-[20px]'>

  ...
  return (
    ...
    <div className='w-full px-[2%] mb-[50px]'>
          <div className='flex justify-between place-items-center'>
              <h1 className='text-[18px] lg:text-[20px] font-normal'>New User</h1>
      ...
      <SelectContent>
          ...
          <SelectItem value="option3">Option 3</SelectItem>
            ...
            <div>
            <h1 className='text-[12px] xl:text-[14px] font-semibold text-[#8225AF] mt-[15px] xl:mt-[20px]'>Set Password</h1>
            
            <div className='mt-[15px] xl:mt-[20px] grid grid-cols-2 gap-[15px] lg:gap-[20px]'>
              
              <div>
                 <Input type="title" placeholder="Password" />
              </div>
               <div>
                 <Input type="title" placeholder="Confirm Password" />
              </div>

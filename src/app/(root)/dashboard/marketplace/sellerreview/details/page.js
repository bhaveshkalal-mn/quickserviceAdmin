...
function page() {
  ...
  return (
    ...
    <div className='w-full px-[2%]'>
        ...
        <Save/>
        <Image alt='delete'   width={0} height={0} className='w-[18px] lg:w-[20px] xl:w-[22px] h-[18px] lg:h-[20px] xl:h-[22px] cursor-pointer' src="/assests/selleradmin/icon/delete.svg"/>
           ...
           <Image alt='back' onClick={() => router.back()} width={0} height={0} className='w-[18px] lg:w-[20px] xl:w-[22px] h-[18px] lg:h-[20px] xl:h-[22px] cursor-pointer' src="/assests/selleradmin/comman/backarray.svg"/>
                ...
                <div className='px-[25px] py-[20px]'>
                    ...
                    <div className='mt-[15px] lg:mt-[20px] xl:mt-[30px]'>
                           <h1 className='text-[14px] xl:text-[16px] font-medium text-[#8225AF]'>Seller Review</h1>
                            ...
                            <div className='mt-[10px] xl:mt-[15px]'>
                                ...
                                <div className='mt-[20px] xl:mt-[25px] mb-[70px]'>

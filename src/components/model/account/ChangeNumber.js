...
function ChangeNumber({ showCancelIcon }) {
  return (
   <div>
        ...
        <DialogContent showCancelIcon = {false} className='w-[90%] md:w-[350px]  lg:w-[400px] xl:w-[450px] bg-[#fff]    rounded-[10px] border-[1px] border-[#DDD] p-0'>
          <div className='w-[100%] h-[100%] '>
            <div className='px-[20px] xl:px-[30px]   py-[20px] '>
                <h1 className='text-[16px] xl:text-[18px] font-normal'>Change Mobile Number</h1>
                <div className='mt-[30px] xl:mt-[35px]'>
                    ...
                    <input
                      ...
                      className='outline-none w-[80%] text-[13px] placeholder:opacity-50  xl:text-[15px] placeholder:text-[black] '
                      placeholder='Enter Mobile Number'
                    />
                    <h1 className='text-[13px] xl:text-[15px] font-normal text-right w-[20%]'>Send OTP</h1>
                  </div>
                    ...
                    />
                    <h1 className='text-[13px] xl:text-[15px] font-normal text-[#9317CF] text-right w-[20%]'>0:50</h1>
                  </div>
